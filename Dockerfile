...
ENV NEXT_PUBLIC_ADMIN_API_URL=${NEXT_PUBLIC_ADMIN_API_URL:-http://localhost:8081/api}

ARG NEXT_PUBLIC_EXTRACTION_API_URL
ENV NEXT_PUBLIC_EXTRACTION_API_URL=${NEXT_PUBLIC_EXTRACTION_API_URL:-http://localhost:8002/api}
